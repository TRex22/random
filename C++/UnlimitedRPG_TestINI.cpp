...
class player
{
 ...
 //don't need to check if level=0, cause we've just created the object.
        level = GetPrivateProfileInt("player","level",1,"URPG.ini");
        experience = GetPrivateProfileInt("player","exp",0,"URPG.ini");
        health = GetPrivateProfileInt("player","hp",0,"URPG.ini");
        maxhealth = GetPrivateProfileInt("player","maxhp",0,"URPG.ini");
		spirit = GetPrivateProfileInt("player","spirit",0,"URPG.ini");
		fatigue = GetPrivateProfileInt("player","fatigue",0,"URPG.ini");
        atk = GetPrivateProfileInt("player","atk",0,"URPG.ini");
		maxAtk = GetPrivateProfileInt("player","maxatk",0,"URPG.ini");
        def = GetPrivateProfileInt("player","def",0,"URPG.ini");
		maxDef = GetPrivateProfileInt("player","maxdef",0,"URPG.ini");
        bank = GetPrivateProfileInt("player","bank",0,"URPG.ini");
		stat = GetPrivateProfileInt("player","stat",0,"URPG.ini");
		needed = GetPrivateProfileInt("player","needed",0,"URPG.ini");
		addAtk = GetPrivateProfileInt("player","addatk",0,"URPG.ini");
		addDef = GetPrivateProfileInt("player","adddef",0,"URPG.ini");
		deaths = GetPrivateProfileInt("player","deaths",0,"URPG.ini");

		//items
		knife = GetPrivateProfileInt("player","knife",0,"URPG.ini");
		sword = GetPrivateProfileInt("player","sword",0,"URPG.ini");
		spear = GetPrivateProfileInt("player","spear",0,"URPG.ini");
		shield = GetPrivateProfileInt("player","shield",0,"URPG.ini");
		chestplate = GetPrivateProfileInt("player","chestplate",0,"URPG.ini");
		helm = GetPrivateProfileInt("player","helm",0,"URPG.ini");
		totem_a = GetPrivateProfileInt("player","totem_a",0,"URPG.ini");
		totem_b = GetPrivateProfileInt("player","totem_b",0,"URPG.ini");
		totem_c = GetPrivateProfileInt("player","totem_c",0,"URPG.ini");
...
class monster
{
  public:
    ...
    monster()
    {
      atk=GetPrivateProfileInt("enemy","atk",0,"URPG.ini");
      def=GetPrivateProfileInt("enemy","def",0,"URPG.ini");
      hp= GetPrivateProfileInt("enemy","hp",0,"URPG.ini");
      maxhp=GetPrivateProfileInt("enemy","maxhp",0,"URPG.ini");
      level=GetPrivateProfileInt("enemy","level",0,"URPG.ini");
    };
};
...
int give();
int take();
int save(player &thisPlayer, monster &thisMonster);
...
int save(player &thisPlayer, monster &thisMonster)
{
	WritePrivateProfileString("player",itoa(thisPlayer.level,convert,10),"%n","URPG.ini");
	return 0;
}
